...
/**
 * Interface for weight functions. A weight function is the first derivative of a symmetric robust
 * function p(sqrt(t)). The errors are assumed to be normalized to unit variance.
 *
 * See:
