...
public:
  PoseOptimizerTest()
  {
    ...
    vk::blender_utils::loadBlenderDepthmap(
      dataset_dir + "/depth/frame_000002_0.depth", *cam_, depthmap_);
  ...
  virtual ~PoseOptimizerTest() { delete cam_; }
...
void PoseOptimizerTest::test(const Vector3d & pose_disturbance, double pixel_sigma2)
{
  ...
  pose_optimizer::optimizeGaussNewton(
    Config::reprojThresh(), 10, true, frame_, estimated_scale, error_init, error_final, num_obs);
}
