...
public:
  ...
  std::vector<Feature *> key_pts_;   //!< Five features and associated 3D points which are used to
                                     //!< detect if two frames have overlapping field of view.
  ...
  inline static void jacobian_xyz2uv(const Vector3d & xyz_in_f, Eigen::Matrix<double, 2, 6> & J)
  {
